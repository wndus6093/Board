...
@WebMvcTest(ArticleCommentContoller.class)
class ArticleCommentContollerTest {
    ...
    public ArticleCommentContollerTest(
    ...
    @WithUserDetails(value="wndustest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
